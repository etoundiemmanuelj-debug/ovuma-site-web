        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start mb-4">
              <BetaSignupModal>
                <button className="inline-flex items-center justify-center gap-3 px-5 py-3 bg-foreground text-background rounded-xl hover:bg-foreground/90 transition-all hover:scale-105 shadow-lg group">
