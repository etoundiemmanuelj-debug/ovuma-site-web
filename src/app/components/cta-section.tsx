            ...
            <div className="grid md:grid-cols-2 gap-0">
              ...
              >
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full mb-6 w-fit">
                  ...
                  <span className="text-primary font-medium text-sm">Téléchargez maintenant</span>
                </div>
                ...
                >
                  ...
                  <span className="block text-primary mt-1">dès aujourd'hui</span>
                </h2>

                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  Téléchargez l'application gratuitement et accédez à toutes nos fonctionnalités. Disponible sur iOS et Android.
                </p>
                ...
                <div className="space-y-3 mb-8">
                  {[
                    ...
                    "Accès hors ligne aux leçons",
                    "Synchronisation multi-appareils",
                    "Mises à jour régulières avec de nouvelles langues",
                  ].map((benefit, index) => (
                ...
                <p className="text-xs text-muted-foreground mt-4">
                  Plus de 5 000 téléchargements • Note moyenne 4.9/5 ⭐
                </p>
              </motion.div>
